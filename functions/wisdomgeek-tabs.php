...
class WGTabs extends WP_Widget {

/*  Constructor
/* ------------------------------------ */
	function __construct() {
		parent::__construct( false, esc_html__( 'WG Tabs', 'alx' ), array('description' => esc_html__('List posts, comments, and/or tags with or without tabs.', 'alx' ), 'classname' => 'widget_wg_tabs', 'customize_selective_refresh' => true ) );
	}

	public function wg_get_defaults() {
		return array(
			'title'				=> '',
			'tabs_category'		=> 1,
			'tabs_date'			=> 1,
...
/*  Register widget
/* ------------------------------------ */
if ( ! function_exists( 'wg_register_widget_tabs' ) ) {

	function wg_register_widget_tabs() {
		register_widget( 'WGTabs' );
	}

}
add_action( 'widgets_init', 'wg_register_widget_tabs' );